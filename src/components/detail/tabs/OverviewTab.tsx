...
export default function OverviewTab({ project: p, allTags, onUpdate, onTagChange }: Props) {
  return (
    <>
      ...
      <div className="meta-grid">
        {([['BPM', p.bpm], ['Time', p.timeSignature], ['Tracks', p.trackCount], ['Duration', formatDuration(p.durationSecs)]] as const).map(([l, v]) => (
