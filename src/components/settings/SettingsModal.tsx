    ...
    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
      <div
        style={{
          flex: 1,
          fontSize: 11,
          color: path ? "var(--text-2)" : "var(--text-3)",
...
export default function SettingsModal({ onClose }: Props) {
  ...
  const [gdriveFolderCfg, setGDriveFolderCfg] = useState<LocalConfig | null>(
    null,
  );
  ...
  const handleLyricsAIChange = useCallback(async (next: LyricsAIConfig) => {
    ...
    window.dispatchEvent(
      new CustomEvent("lyrics-ai-config-changed", { detail: next }),
    );
  }, []);
      ...
      >
        ...
        >
          ...
          <section>
            ...
            <Hint>
              Backups are saved as ZIP files in this folder. Choose any local
              drive or external disk.
            </Hint>
            <FolderRow
              path={localCfg?.destination ?? null}
          ...
          <section>
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              <Hint>
                If you have <b>Google Drive for Desktop</b> installed, it syncs
                a local folder on your Mac. Pick that folder and backups will
                appear in your Drive automatically — no API setup needed.
              </Hint>
            ...
            <div>
              ...
              <Hint>
                Uploads backups directly via the Google Drive API. Requires
              ...
              >
                <li>
                  Go to <b>console.cloud.google.com</b> and create a project
                </li>
                <li>
                  Enable the <b>Google Drive API</b> for that project
                </li>
                <li>
                ...
                <li>
                  Choose <b>Desktop app</b> as the application type
                </li>
                <li>
              ...
              {gdriveCfg?.refreshToken ? (
                ...
                >
                  ...
                  />
                  {connectErr && (
                    <div style={{ fontSize: 11, color: "#ff5a5a" }}>
                      {connectErr}
                    </div>
                  )}
                  <button
          ...
          <section>
            ...
            <Hint>
              Used by the Tab structure generator. Choose a provider and enter
              your credentials.
            </Hint>
            ...
            <div style={{ display: "flex", gap: 4, marginBottom: 12 }}>
              {PROVIDERS.map((p) => (
                <button
                  ...
                  onClick={() =>
                    handleSaveAI({ ...aiCfg, provider: p.id, model: "" })
                  }
                >
                  {p.label}
                </button>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              ...
              {isCloud && (
                <input
                  ...
                  value={aiCfg.apiKey}
                  onChange={(e) =>
                    handleSaveAI({ ...aiCfg, apiKey: e.target.value })
                  }
                  style={{
                    fontSize: 11,
                    padding: "6px 8px",
              ...
              {isLocal && (
                <input
                  ...
                  value={aiCfg.baseUrl}
                  onChange={(e) =>
                    handleSaveAI({ ...aiCfg, baseUrl: e.target.value })
                  }
                  style={{
                    fontSize: 11,
                    padding: "6px 8px",
              ...
              <input
                ...
                placeholder={
                  modelOptions
                    ? "Model name or pick from list…"
                    : "Model name (e.g. llama3, mistral)"
                }
                value={aiCfg.model}
                onChange={(e) =>
                  handleSaveAI({ ...aiCfg, model: e.target.value })
                }
                style={{
                  fontSize: 11,
                  padding: "6px 8px",
          ...
          <section>
            ...
            <Hint>
              AI-powered autocomplete and brainstorm suggestions while writing
              lyrics. Uses your AI assistant settings above.
            </Hint>
            <LyricsAiSettings
              cfg={lyricsAICfg}
